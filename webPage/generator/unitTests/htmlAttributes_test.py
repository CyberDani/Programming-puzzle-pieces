...
class HtmlAttributesTests(unittest.TestCase):
  ...
  def test_getAttributeIdx_corrupt(self):
    corrupt, idx = attr.getAttributeIdx("'class my-class' class='myClass'", "class")
    self.assertTrue(corrupt)
    self.assertEqual(idx, -1)
    corrupt, idx = attr.getAttributeIdx("class'myClass' class='myClass'", "class")
    self.assertTrue(corrupt)
    self.assertEqual(idx, -1)
    corrupt, idx = attr.getAttributeIdx("class' title=\"heyo\"", "class")
    self.assertTrue(corrupt)
    self.assertEqual(idx, -1)
    corrupt, idx = attr.getAttributeIdx("'class' title=\"heyo\"", "class")
    self.assertTrue(corrupt)

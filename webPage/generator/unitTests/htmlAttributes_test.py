...
class HtmlAttributesTests(unittest.TestCase):
  ...
  def helper_getCurrentOrNextAttribute_testCorrupt(self, corrupt, attributeName, attributeValue, startIdx, endIdx):
    self.assertTrue(corrupt)
  ...
  def helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt(self, htmlAttributes):
    *returnValues, = attr.getCurrentOrNextAttribute(htmlAttributes, 0)
    self.helper_getCurrentOrNextAttribute_testCorrupt(*returnValues)

  def helper_getCurrentOrNextAttribute_testAttributeNotFound(self, corrupt, attributeName, attributeValue, startIdx, endIdx):
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, None)
    self.assertEqual(attributeValue, None)
    self.assertEqual(startIdx, -1)
  ...
  def helper_getCurrentOrNextAttribute_checkAttributeNotFound(self, htmlAttributes, startIdx):
    *returnValues, = attr.getCurrentOrNextAttribute(htmlAttributes, startIdx)
    self.helper_getCurrentOrNextAttribute_testAttributeNotFound(*returnValues)

  def test_getCurrentOrNextAttribute_attributeNotFound(self):
    self.helper_getCurrentOrNextAttribute_checkAttributeNotFound(" ", 0)
    self.helper_getCurrentOrNextAttribute_checkAttributeNotFound("\t\t", 0)
    self.helper_getCurrentOrNextAttribute_checkAttributeNotFound("id='content' ", 12)
    self.helper_getCurrentOrNextAttribute_checkAttributeNotFound("\n  \t\t\t    \r\n", 0)
    self.helper_getCurrentOrNextAttribute_checkAttributeNotFound("selected id='x'\n  \t\t\t    \r\n", 16)
    self.helper_getCurrentOrNextAttribute_checkAttributeNotFound("selected id='x'\n  \t\t\t    \r\n", 18)

  def test_getCurrentOrNextAttribute_corrupt(self):
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("=")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("\"")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("'\"")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("\"'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("\"\"")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("''")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("\"value\"")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("'value'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("\"\"\"")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("'''")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("=value")
    ...
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("= 'value'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("\t= 'value'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("class= ='myClass'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("class=='myClass'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("class==='myClass'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("class == 'myClass'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("class =  = 'myClass'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("class=")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("class=\t")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("class =")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("class\t=")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("class \t \t =")
    ...
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value=\"   ")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value=\t \"   ")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value=\t   class='bordered'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value=\t \"   class='bordered'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value=\"audi")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value=\"audi\r\n")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value=\"audi\r\n selected")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value=\"audi'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value=\"audi' class='black-bg'")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value=\"audi' selected")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value='audi\"")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value='audi\" selected")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value='audi\" id=\"my-id\"")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value \"audi\"")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value  \"audi\"")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value \t\t\t \"audi\"")
    self.helper_getCurrentOrNextAttribute_checkHtmlAttributesIsCorrupt("value\"audi\"")
  ...
  def test_getCurrentOrNextAttribute_noAttributeValue(self):
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("x", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "x")
    self.assertEqual(attributeValue, None)
    self.assertEqual(startIdx, 0)
    self.assertEqual(endIdx, 0)
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("selected", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "selected")
    self.assertEqual(attributeValue, None)
    self.assertEqual(startIdx, 0)
    self.assertEqual(endIdx, 7)
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("selected class=\"my-class\" "
                                                                                "no-href id='my-id'", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "selected")
    self.assertEqual(attributeValue, None)
    self.assertEqual(startIdx, 0)
    self.assertEqual(endIdx, 7)
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("selected  \t \n  class=\"my-class\" "
                                                                                "no-href id='my-id'", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "selected")
    self.assertEqual(attributeValue, None)
    ...
    self.assertEqual(startIdx, 0)
    self.assertEqual(endIdx, 7)
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("selected\t animated\nid=\"my-id\"", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "selected")
    self.assertEqual(attributeValue, None)
    self.assertEqual(startIdx, 0)
    ...
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute(" selected minimized", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "selected")
    self.assertEqual(attributeValue, None)
    self.assertEqual(startIdx, 1)
    self.assertEqual(endIdx, 8)
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute(" \t  \r\n  selected", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "selected")
    self.assertEqual(attributeValue, None)
    ...
    self.assertEqual(endIdx, 8)
    string = " \t  \r\n  selected\t\t\t\r\n"
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute(string, 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "selected")
    self.assertEqual(attributeValue, None)
    self.assertEqual(startIdx, 8)
  ...
  def test_getCurrentOrNextAttribute_attributeValue(self):
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("id='my-id'", 0)
    self.assertFalse(corrupt)
    ...
    self.assertEqual(endIdx, string.find("'\r\n "))
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("id = 'id1 id2'", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "id")
    self.assertEqual(attributeValue, "id1 id2")
    self.assertEqual(startIdx, 0)
    self.assertEqual(endIdx, 13)
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("id = ' id1 id2 id3 '", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "id")
    self.assertEqual(attributeValue, " id1 id2 id3 ")
    self.assertEqual(startIdx, 0)
    self.assertEqual(endIdx, 19)
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("\tid = '\r\n id1 id2 id3 \n\t'\t\t", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "id")
    ...
    self.assertEqual(startIdx, 1)
    self.assertEqual(endIdx, string.find("'\t\t"))
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("id = 'id1 id2' id=\"my-other-id\"", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "id")
    self.assertEqual(attributeValue, "id1 id2")
    self.assertEqual(startIdx, 0)
    self.assertEqual(endIdx, 13)
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("title=\"class='myClass'\"", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "title")
    self.assertEqual(attributeValue, "class='myClass'")
    self.assertEqual(startIdx, 0)
    self.assertEqual(endIdx, 22)
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("title=\"class='myClass'\""
                                                                                         "selected", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "title")
    self.assertEqual(attributeValue, "class='myClass'")
    ...
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("title=\"===>A'B'C<===\""
                                                                                         "selected", 0)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "title")
  ...
  def test_getCurrentOrNextAttribute_indexPointsWithinAttributeName(self):
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("selected", 2)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "selected")
    self.assertEqual(attributeValue, None)
    self.assertEqual(startIdx, 0)
    self.assertEqual(endIdx, 7)
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("selected='False'", 3)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "selected")
    self.assertEqual(attributeValue, "False")
    self.assertEqual(startIdx, 0)
    self.assertEqual(endIdx, 15)
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute("selected='False'", 7)
    self.assertFalse(corrupt)
    self.assertEqual(attributeName, "selected")
    self.assertEqual(attributeValue, "False")
    self.assertEqual(startIdx, 0)
    ...
    corrupt, attributeName, attributeValue, startIdx, endIdx = attr.getCurrentOrNextAttribute(string, string.find("class"))
    self.assertFalse(corrupt)

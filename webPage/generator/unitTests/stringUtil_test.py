...
class StringUtilTests(AutoUnitTest):
  ...
  def test_indexIsOutsideOfPythonStringConstant_false(self):
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("Q", 0))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("'Q", 0))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("'Q", 1))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("'Q\"", 0))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("'Q\"", 1))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("'Q\"", 2))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("str: 'this is my \\'happy little\\' string' ", 41))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("str: 'this is my \\'happy little\\' string' ", 3))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("str: 'this is my \\'happy little\\' string' ", 4))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("str = 'string1' + \"string2\" + str", 5))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("str = 'string1' + \"string2\" + str", 15))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("str = 'string1' + \"string2\" + str", 17))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("str = 'string1' + \"string2\" + str", 27))
    self.assertFalse(stringUtil.indexIsOutsideOfPythonStringConstant("str = 'string1' + \"string2\" + str", 32))
  ...
  def test_indexIsOutsideOfPythonStringConstant_true(self):
    ...
    self.assertTrue(func("str: 'this is my \\'happy little\\' string'", 5))
    self.assertTrue(func("str: 'this is my \\'happy little\\' string'", 40))
    self.assertTrue(func("str: 'this is my \\'happy little\\' string'", 17))
    self.assertTrue(func("str: 'this is my \\'happy little\\' string'", 18))
    self.assertTrue(func("str: 'this is my \\'happy little\\' string'", 31))
    self.assertTrue(func("str: 'this is my \\'happy little\\' string'", 32))
    self.assertTrue(func("str: 'this is my \\'happy little\\' string'", 33))
    self.assertTrue(func("str: 'this is my \\'happy little\\' string'", 39))
    self.assertTrue(func("'string\\'1\\\\' + \"string''2'\" + 'str\"ing3'", 0))
    self.assertTrue(func("'string\\'1\\\\' + \"string''2'\" + 'str\"ing3'", 10))
    self.assertTrue(func("'string\\'1\\\\' + \"string''2'\" + 'str\"ing3'", 11))
    self.assertTrue(func("'string\\'1\\\\' + \"string''2'\" + 'str\"ing3'", 12))
    self.assertTrue(func("'string\\'1\\\\' + \"string''2'\" + 'str\"ing3'", 16))
    self.assertTrue(func("'string\\'1\\\\' + \"string''2'\" + 'str\"ing3'", 20))
    self.assertTrue(func("'string\\'1\\\\' + \"string''2'\" + 'str\"ing3'", 25))
    self.assertTrue(func("'string\\'1\\\\' + \"string''2'\" + 'str\"ing3'", 26))
    self.assertTrue(func("'string\\'1\\\\' + \"string''2'\" + 'str\"ing3'", 27))

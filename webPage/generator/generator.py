...
def writeHtmlBodyContent(htmlFile, indentDepth):
  ...
  includeFileToHtmlOutputFile(htmlFile, "../pages/mainPage/svgCurve1.txt", indentDepth + 1)
  includeFileToHtmlOutputFile(htmlFile, "../pages/mainPage/whatThisProjectOffers.txt", indentDepth + 1)
  includeFileToHtmlOutputFile(htmlFile, "../pages/mainPage/svgCurve2.txt", indentDepth + 1)
  includeFileToHtmlOutputFile(htmlFile, "../pages/mainPage/personalRecommandation.txt", indentDepth + 1)
  includeFileToHtmlOutputFile(htmlFile, "../pages/mainPage/svgCurve3.txt", indentDepth + 1)
  includeFileToHtmlOutputFile(htmlFile, "../pages/mainPage/textBelowCurves.txt", indentDepth + 1)
